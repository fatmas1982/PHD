...
singularity exec ~/data/containers/TensorFlow/tf-gpu.img ~/gpu/cs/FJ-3/File_Graph_Process_External_File_Sim.py ${SLURM_ARRAY_TASK_ID} $all_gpus $cuda $processor $dataset
