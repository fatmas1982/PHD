...
singularity exec ~/data/containers/TensorFlow/tf-gpu.img ~/gpu/split/FJ-2/File_Graph_Process_Internal_File_Sim.py ${SLURM_ARRAY_TASK_ID} $all_gpus $cuda $processor $dataset
