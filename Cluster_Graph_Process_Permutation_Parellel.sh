...
#SBATCH --array=0-117#SBATCH --error=prmu_%A.stderr
#SBATCH --export=ALL
#SBATCH --exclude=comp005,comp004
...
singularity exec ~/data/containers/TensorFlow/tf-gpu.img ~/gpu/split/CJ-1/Cluster_Graph_Process_Permutation.py ${key} ${all_gpus} ${file} ${cuda} $processor $dataset
