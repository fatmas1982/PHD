...
singularity exec ~/data/containers/TensorFlow/tf-gpu.img ~/gpu/cs/FJ-1/File_Graph_Process_One_File_TF_IDF_Remove_Redundant.py ${SLURM_ARRAY_TASK_ID} $all_gpus $cuda $processor $dataset
